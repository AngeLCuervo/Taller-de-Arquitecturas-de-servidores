...
2. An EC2 instance (Amazon Linux 2 or Ubuntu recommended)
3. Security group allowing inbound traffic on port 8080
...
![AWS Deployment Screenshot](docs/aws-deployment.png)

*Note: Replace with your actual AWS deployment screenshot*
